...
namespace StylizedVolumetricLighting
{
	static public class VolumetricLightResources
	{
		...
		public const string TT_CLOUDDATARESOLUTION = "Resolution of cloud data."+
		 ...
		 +" Instead of increasing resolution, consider shortening the gap between 'Cloud Near Clip Plane' and 'Cloud Far Clip Plane' for better visuals. This area can be visualized in editor by enabling the 'Show Cloud Area In Editor' checkbox.";
